    ...
    <div class="acc__wrapper">
        ...
        <div class="acc-content__wrapper">
            <div class="acc-content active steps-wrapper">
                <form id="form-create-order-storage-on-pallets" action="{{ route('account.orders.create.storage-on-pallets') }}" method="post">
                    @csrf
                    @method('post')
                    ...
                    <div class="on step1 step-container" data-step="1">
                        ...
                        <div class="on-b">
                            @include('application.components.order.product-item', ['title' => __('Pallet'), 'price' => settings()->get('price_pallet_storage', 0), 'description' => __(''), 'image' => asset('storage/images/order-item-3.png'), 'name' => 'pallets'])
